...
char devname[30];
String devstr =  "camerasieungaura";

int IncludeInternet = 3;      // 0 for no internet, 1 for time only, 2  WiFiMan, 3 ssid in file, 4 ssid in file default off, 5 host mode

const char* ssid = "Redmi12";

// https://sites.google.com/a/usapiens.com/opnode/time-zones  -- find your timezone here
String TIMEZONE = "WIB-7";
...
int qualityconfig = 5;
int buffersconfig = 3;
int avi_length = 10;            // how long a movie in seconds -- 1800 sec = 30 min
